...
pub use flopsynth::{
    ...
    MATRIX_ROW, MATRIX_ROWS_LEAST, MatrixHit, MatrixRow, NAMEPLATE_CHIP_W, NODE_GRAB,
    PICTURE_FLOOR, PICTURE_HEIGHT, PRESET_ROW, PresetBrowse, PresetShelf, PresetsHit,
    PresetsLayout, RESPONSE_BOTTOM_DB, RESPONSE_TOP_DB, RING_BAND, RING_GAP, TAB_HEIGHT,
    WIDE_CHOICE, badge_at, cell_span, control_at, env_curve_points, env_node_at, env_node_drag,
    filter_xy_at, flop_knob_rect, flopsynth_hit, flopsynth_layout, flopsynth_tab_at,
    is_nameplate_control, lfo_curve_points, matrix_depth_at, matrix_hit, picture_control,
    preset_about, preset_page_rows, preset_shelves, presets_hit, response_curve_points, ring_depth,
    ring_hit, sound_outline_points, wave_curve_points, wave_position_at,
};
pub use instrument::{
