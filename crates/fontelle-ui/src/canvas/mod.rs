...
pub use flopsynth::{
    ...
    FlopsynthShowing, FlopsynthView, FxRackHit, FxRackRow, FxRackSlot, Grid, HeaderChip,
    ...
    flopsynth_layout, flopsynth_layout_with, flopsynth_tab_at, fx_rack_hit, fx_rack_landing,
    fx_rack_mix_at, is_nameplate_control, lamp_dots, lfo_curve_points, lfo_point_add,
